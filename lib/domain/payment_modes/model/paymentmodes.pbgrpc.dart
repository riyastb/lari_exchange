...
class PaymentModesClient extends $grpc.Client {
  ...
  static final _$getByName = $grpc.ClientMethod<$0.GetRequest, $0.Payload>(
      '/paymentmodes.PaymentModes/GetByName',
      ($0.GetRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.Payload.fromBuffer(value));
  static final _$getAll = $grpc.ClientMethod<$0.Empty, $0.Payload>(
      '/paymentmodes.PaymentModes/GetAll',
      ($0.Empty value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.Payload.fromBuffer(value));
  static final _$getAllOnline = $grpc.ClientMethod<$0.Empty, $0.Payload>(
      '/paymentmodes.PaymentModes/GetAllOnline',
      ($0.Empty value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.Payload.fromBuffer(value));

  PaymentModesClient($grpc.ClientChannel channel,
  ...
  $grpc.ResponseFuture<$0.Payload> getByName($0.GetRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseStream<$0.Payload> getAllOnline($0.Empty request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(
        _$getAllOnline, $async.Stream.fromIterable([request]),
        options: options);
  }
}

abstract class PaymentModesServiceBase extends $grpc.Service {
  $core.String get $name => 'paymentmodes.PaymentModes';

  PaymentModesServiceBase() {
  ...
  $async.Future<$0.Payload> getByName_Pre(
      $grpc.ServiceCall call, $async.Future<$0.GetRequest> request) async {
  ...
  $async.Stream<$0.Payload> getAllOnline_Pre(
      $grpc.ServiceCall call, $async.Future<$0.Empty> request) async* {
  ...
  $async.Future<$0.Payload> getByName(
      $grpc.ServiceCall call, $0.GetRequest request);
  $async.Stream<$0.Payload> getAll($grpc.ServiceCall call, $0.Empty request);
  $async.Stream<$0.Payload> getAllOnline(
