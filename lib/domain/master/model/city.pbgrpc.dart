...
class CityClient extends $grpc.Client {
  ...
  CityClient($grpc.ClientChannel channel,
...
abstract class CityServiceBase extends $grpc.Service {
  $core.String get $name => 'city.City';
