...
const Payload$json = const {
  ...
  '2': const [
    ...
    const {'1': 'Emirates', '3': 5, '4': 1, '5': 9, '10': 'Emirates'},
  ],
};

/// Descriptor for `Payload`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List payloadDescriptor = $convert.base64Decode('CgdQYXlsb2FkEg4KAklkGAEgASgJUgJJZBISCgROYW1lGAIgASgJUgROYW1lEhIKBENvZGUYAyABKAlSBENvZGUSGAoHQ291bnRyeRgEIAEoCVIHQ291bnRyeRIaCghFbWlyYXRlcxgFIAEoCVIIRW1pcmF0ZXM=');
