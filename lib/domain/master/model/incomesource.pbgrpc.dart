...
import 'incomesource.pb.dart' as $0;
export 'incomesource.pb.dart';

class IncomeSourceClient extends $grpc.Client {
...
abstract class IncomeSourceServiceBase extends $grpc.Service {
  $core.String get $name => 'incomesource.IncomeSource';

  IncomeSourceServiceBase() {
