...
const Payload$json = const {
  ...
  '2': const [
    ...
    const {'1': 'CountryId', '3': 4, '4': 1, '5': 9, '10': 'CountryId'},
    const {'1': 'CountryName', '3': 5, '4': 1, '5': 9, '10': 'CountryName'},
  ],
};

/// Descriptor for `Payload`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List payloadDescriptor = $convert.base64Decode('CgdQYXlsb2FkEg4KAklkGAEgASgJUgJJZBISCgROYW1lGAIgASgJUgROYW1lEhIKBENvZGUYAyABKAlSBENvZGUSHAoJQ291bnRyeUlkGAQgASgJUglDb3VudHJ5SWQSIAoLQ291bnRyeU5hbWUYBSABKAlSC0NvdW50cnlOYW1l');
@$core.Deprecated('Use getRequestDescriptor instead')
const GetRequest$json = const {
  '1': 'GetRequest',
  '2': const [
    const {'1': 'Id', '3': 1, '4': 1, '5': 9, '10': 'Id'},
    const {'1': 'CountryId', '3': 2, '4': 1, '5': 9, '10': 'CountryId'},
  ],
};

/// Descriptor for `GetRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getRequestDescriptor = $convert.base64Decode('CgpHZXRSZXF1ZXN0Eg4KAklkGAEgASgJUgJJZBIcCglDb3VudHJ5SWQYAiABKAlSCUNvdW50cnlJZA==');
