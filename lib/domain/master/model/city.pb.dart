...
class Payload extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Payload', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'city'), createEmptyInstance: create)
    ...
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'DistrictId', protoName: 'DistrictId')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'DistrictName', protoName: 'DistrictName')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'StateId', protoName: 'StateId')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'StateName', protoName: 'StateName')
  ...
  @$pb.TagNumber(4)
  $core.String get districtId => $_getSZ(3);
  @$pb.TagNumber(4)
  set districtId($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(6)
  $core.String get stateId => $_getSZ(5);
  @$pb.TagNumber(6)
  set stateId($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(6)
  $core.bool hasStateId() => $_has(5);
  @$pb.TagNumber(6)
  void clearStateId() => clearField(6);

  @$pb.TagNumber(7)
  $core.String get stateName => $_getSZ(6);
  @$pb.TagNumber(7)
  set stateName($core.String v) { $_setString(6, v); }
  @$pb.TagNumber(7)
  $core.bool hasStateName() => $_has(6);
  @$pb.TagNumber(7)
  void clearStateName() => clearField(7);
}

class GetRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'city'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'Id', protoName: 'Id')
...
class Response extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Response', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'city'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'Id', protoName: 'Id')
...
class Empty extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Empty', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'city'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
